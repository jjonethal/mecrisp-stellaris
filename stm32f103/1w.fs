...
gpiob $8 + constant GPIOB_IDR
gpiob $c + constant GPIOB_ODR

: shm 1wDQ 4 * lshift ;

: 1w.init gpiob @ $fffffff0 and gpiob ! ;
: 1w.output %11 gpiob bis! %1000 gpiob bic! 1 GPIOB_ODR bic! ;
: 1w.input %11 gpiob bic! %1000 gpiob bis! GPIOB_ODR @ 1 or GPIOB_ODR ! ;
: 1w.out0 1wDQmask 16 lshift gpiob_bsrr ! ;
: 1w.out1 1wDQmask gpiob_bsrr ! ;
: 1w.in 1wDQmask gpiob_idr bit@ ;
...
;                
  ...
  \       
    ...
    \
    \
        0  variable 1w_last   \ количество 1-wire приборов на шине 
       $10 variable max_1w   \ кол-во 1-wire устройств ( 16*8= 128байт )
