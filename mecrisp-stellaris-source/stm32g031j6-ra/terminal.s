...
@ Porting: Rewrite this !
        ...
        @ USART2 register map Tx=PA2, Rx=PA15
...
@ -----------------------------------------------------------------------------
  ...
  ldr r1, = GPIOA_MODER
  ldr r0, = 0xABFFFFEF @ 0xEBFF FFFF is Reset value for Port A, and switch PA2 and PA15 to alternate function
  str r0, [r1]

  @ Set alternate function 1 to enable USART2 TX=PA2 pin on Port A
  ldr r1, = GPIOA_AFRL
  ldr r0, = 0x0100      @ Alternate function 1 for TX pin of USART2 on PORTA 
  str r0, [r1]

  @ Set alternate function 1 to enable USART2 RX=PA15 pin on Port A
  ldr r1, = GPIOA_AFRH
  ldr r0, = 0x10000000      @ Alternate function 1 for RX pin of USART2 on PORTA 
  str r0, [r1]
