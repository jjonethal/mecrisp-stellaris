...
1:ldr r0, [r1]      @ Check HSIRDY flag
  ...
  ldr r1, = GPIOA_MODER
  ldr r0, = 0xEBEBFCFF @ EBFF FCFF is Reset value for Port A, and switch PA9 and PA10 to alternate function
  @ ldr r0, = 0xEBEBF4FF @ EBFF FCFF is Reset value for Port A, and switch PA9 and PA10 to alternate function, PA5 Output for red LED
  str r0, [r1]
