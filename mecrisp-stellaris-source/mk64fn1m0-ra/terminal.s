...
@ The primary serial port interface signals are PTB16 RX and PTB17 TX. These signals are connected to the OpenSDA v2 circuit.
...
@ Agenda: More registers for enabling the FIFO !
...
@ -----------------------------------------------------------------------------
  ...
  ldr  r1, = 0x00040182 | SIM_SCGC5_PORTA_MASK | SIM_SCGC5_PORTB_MASK | SIM_SCGC5_PORTC_MASK | SIM_SCGC5_PORTD_MASK | SIM_SCGC5_PORTE_MASK
  ldr  r0, =SIM_SCGC5 @ Alle GPIO-Ports aktivieren  Switch on clock for all GPIO ports
  str  r1, [r0]

  ldr  r1, = 0xF0100030 | SIM_SCGC4_UART0_MASK @ UART aktivieren
  ldr  r0, =SIM_SCGC4
  str  r1, [r0]
