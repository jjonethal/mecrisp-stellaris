...
@------------------------------------------------------------------------------
  ...
  ldr r0, =FlashDictionarySize @ Every image is $B000 bytes in size
  ldr r1, =FirstDictionary     @ and follows after the Forth core, which is from $1000 to $6000 in SPI flash.
...
@------------------------------------------------------------------------------
  ...
  bl image2spioffset
  pushdaconstw FlashDictionarySize
  pushdaconstw FlashEraseSize
  pushdaconst  FlashEraseCmd
  bl erase_range
...
@------------------------------------------------------------------------------
  ...
  pushdaconstw FlashDictionaryAnfang @ Destination address
  pushdaconstw FlashDictionarySize   @ 44 kb
  bl program_range
