...
1:ldr r0, [r1]      @ Check HSIRDY flag
  ...
  ldr r1, = GPIOA_MODER
  ldr r0, = 0xEBFFFCAF @ EBFF FCFF is Reset value for Port A, and switch PA2 and PA3 to alternate function
  str r0, [r1]

  @ Set alternate function 1 to enable USART2 pins on Port A
  ldr r1, = GPIOA_AFRL
  ldr r0, = 0x4400      @ Alternate function 4 for TX and RX pins of USART2 on PORTA 
  str r0, [r1]
