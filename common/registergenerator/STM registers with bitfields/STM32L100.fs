\  STM32L100 ARM CMSIS-SVD register file for Mecrisp-Stellaris Forth by Matthias Koch
    ...
    $40012700 constant C_ADC  
	 ...
	 RCC $0 + constant RCC_CR	\ 		\  : RESET_RCC_CR $00000300 
        ...
        \ %x  24 lshift RCC_AHBRSTR        \ RCC_DMARST	Bit Offset:24	Bit Width:1
        ...
        \ %x  24 lshift RCC_AHBENR        \ RCC_DMAEN	Bit Offset:24	Bit Width:1
        ...
        \ %x  24 lshift RCC_AHBLPENR        \ RCC_DMALPEN	Bit Offset:24	Bit Width:1
