\  STM32L063x ARM CMSIS-SVD register file for Mecrisp-Stellaris Forth by Matthias Koch
	\  x = 0 or 1 below in the Register Field bit positions 
	 

    $40026000 constant AES  
	 AES $0 + constant AES_CR	\ read-write		\  : RESET_AES_CR $00000000 
        ...
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_DINR        \ AES_AES_DINR	Bit Offset:0	Bit Width:32
        
        AES $C + constant AES_DOUTR	\ read-only		\  : RESET_AES_DOUTR $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_DOUTR        \ AES_AES_DOUTR	Bit Offset:0	Bit Width:32
        
        AES $10 + constant AES_KEYR0	\ read-write		\  : RESET_AES_KEYR0 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_KEYR0        \ AES_AES_KEYR0	Bit Offset:0	Bit Width:32
        
        AES $14 + constant AES_KEYR1	\ read-write		\  : RESET_AES_KEYR1 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_KEYR1        \ AES_AES_KEYR1	Bit Offset:0	Bit Width:32
        
        AES $18 + constant AES_KEYR2	\ read-write		\  : RESET_AES_KEYR2 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_KEYR2        \ AES_AES_KEYR2	Bit Offset:0	Bit Width:32
        
        AES $1C + constant AES_KEYR3	\ read-write		\  : RESET_AES_KEYR3 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_KEYR3        \ AES_AES_KEYR3	Bit Offset:0	Bit Width:32
        
        AES $20 + constant AES_IVR0	\ read-write		\  : RESET_AES_IVR0 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_IVR0        \ AES_AES_IVR0	Bit Offset:0	Bit Width:32
        
        AES $24 + constant AES_IVR1	\ read-write		\  : RESET_AES_IVR1 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_IVR1        \ AES_AES_IVR1	Bit Offset:0	Bit Width:32
        
        AES $28 + constant AES_IVR2	\ read-write		\  : RESET_AES_IVR2 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_IVR2        \ AES_AES_IVR2	Bit Offset:0	Bit Width:32
        
        AES $2C + constant AES_IVR3	\ read-write		\  : RESET_AES_IVR3 $00000000 
        \ %xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  0 lshift AES_IVR3        \ AES_AES_IVR3	Bit Offset:0	Bit Width:32
	 ...
	 RCC $0 + constant RCC_CR	\ 		\  : RESET_RCC_CR $00000300 
        ...
        \ %x  9 lshift RCC_APB1SMENR        \ RCC_LCDSMEN	Bit Offset:9	Bit Width:1
