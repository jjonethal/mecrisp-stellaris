$50060000 constant AES  
       AES $0 + constant AES_CR
       AES $4 + constant AES_SR
       AES $8 + constant AES_DINR
       AES $C + constant AES_DOUTR
       AES $10 + constant AES_KEYR0
       AES $14 + constant AES_KEYR1
       AES $18 + constant AES_KEYR2
       AES $1C + constant AES_KEYR3
       AES $20 + constant AES_IVR0
       AES $24 + constant AES_IVR1
       AES $28 + constant AES_IVR2
       AES $2C + constant AES_IVR3
     ...
     $40007C5C constant OPAMP  
       OPAMP $0 + constant OPAMP_CSR
       OPAMP $4 + constant OPAMP_OTR
       OPAMP $8 + constant OPAMP_LPOTR
     ...
     $40007C04 constant RI  
       RI $4 + constant RI_ICR
       RI $8 + constant RI_ASCR1
       RI $C + constant RI_ASCR2
       RI $10 + constant RI_HYSCR1
       RI $14 + constant RI_HYSCR2
       RI $18 + constant RI_HYSCR3
       RI $1C + constant RI_HYSCR4
